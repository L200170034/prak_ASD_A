...
mh1 = mahasiswa("jono", 20017001, "Kudus", 10000)
mh2 = mahasiswa("indro", 20017002, "solo", 13000)
mh3 = mahasiswa("kasino", 20017004, "semarng", 5000)
mh4 = mahasiswa("desi", 20017006, "karanganyar", 12000)
mh5 = mahasiswa("erna", 20017007, "sukoharjo", 2000)
